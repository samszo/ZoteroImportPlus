 ...
 */
class ZoteroImportplus extends \ZoteroImportplus\Entity\ZoteroImportplus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ZoteroImportplus $proxy) {
