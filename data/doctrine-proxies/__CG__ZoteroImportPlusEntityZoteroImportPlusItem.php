...
namespace DoctrineProxies\__CG__\ZoteroImportplus\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ZoteroImportplusItem extends \ZoteroImportplus\Entity\ZoteroImportplusItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ZoteroImportplusItem $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setImport(\ZoteroImportplus\Entity\ZoteroImportplus $import)
    {
